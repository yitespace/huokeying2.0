  ...
  >
    ...
    >
      <el-form-item label="出行人ID">
        <div>{{ formData.val.uid }}</div>
      </el-form-item>
      <el-form-item label="姓名">
        <div>{{ formData.val.user_name }}</div>
      </el-form-item>
      <el-form-item label="性别">
        <div>{{ formData.val.sex == 1 ? "男" : "女" }}</div>
      </el-form-item>
      <el-form-item label="类型">
        <div>{{ formData.val.user_type == 1 ? "成人" : "儿童" }}</div>
      </el-form-item>
      <el-form-item label="出生日期">
        <div>{{ formData.val.birthday }}</div>
      </el-form-item>
      <el-form-item label="身份证号">
        <div>{{ formData.val.id_card }}</div>
      </el-form-item>
      <!-- <el-form-item label="手机号">
        <div>{{ formData.val.phone || "------" }}</div>
      </el-form-item> -->
      <!-- <el-form-item label="关联用户手机号">
        <div>
          <div>13682956169</div>
          <div>13682956169</div>
        </div>
