...
// 获取表格数据
const getData = () => {
  rq.fetchGet(apiUrl.GET_QUICK_LINK_LIST, query).then((res) => {
...
// 获取详情
const getDetail = async (quick_id: string) => {
  await rq.fetchGet(apiUrl.GET_QUICK_LINK_DETAIL, { quick_id }).then((res) => {
